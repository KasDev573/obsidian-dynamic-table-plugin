...
export const ControlsView: React.FC<ControlsViewProps> = ({
  ...
  /**
   * ✅ NEW: Extract style enhancements to potentially modify control container styles
   */
  ...
  return (
    <div
      className={`dynamic-table-controls ${zebraStriping ? 'dt-controls-zebra' : ''} ${rowHoverHighlight ? 'dt-controls-highlight-on-hover' : ''}`}
      style={{
        display: 'flex',
        flexWrap: 'wrap',
